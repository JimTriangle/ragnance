...
const PortfolioListPage = () => {
  ...
  return (
    <div className="p-4 trading-page-container">
      ...
      <DataTable value={items} dataKey="id" responsiveLayout="scroll">
        <Column field="name" header="Nom" />
        <Column field="exchange" header="Exchange" />
        <Column field="baseCurrency" header="Base" />
        <Column field="budget" header="Budget" body={budgetBody} />
        <Column field="allocPercent" header="% alloué" />
        <Column field="pairsCount" header="Paires" />
